...
const faq: FAQ = [
  ...
  },
  {
    ...
    answer: `<a href="#${SectionsIds.leaderboard}">Список команд-переможців</a> можна переглянути на сайті <a href="http://silpo.ua" target="_blank" rel="noopener noreferrer">silpo.ua</a> на сторінці гри у розділі турнірів. <a href="#${SectionsIds.leaderboard}">Список команд-переможців</a> фіксується о 23:59:59 у останній день турніру. Якщо переможцем стала твоя команда, ти отримаєш індивідуальний одноразовий “Код переможця”, що відображатиметься у грі до закінчення наступного турніру (14 днів).`,
  },
  {
