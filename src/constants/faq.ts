...
const faq: FAQ = [
  ...
  },
  {
    ...
    answer:
      'Завантаж і запусти застосунок Chroma Legends (Хрома Леджендс), натисни кнопку "Скануй картки" у головному меню гри, а потім наведи камеру телефону на QR-код на картці.',
  },
  {
  ...
  },
  {
    ...
    answer: `Колекційні картки у грі поділяються на три види:${Symbols.newLine}• Картки Героїв – відкривають нових Героїв або збільшують максимальний рівень уже наявних.${Symbols.newLine}• Картки Артефактів – відкривають нові Артефакти або покращують їхні характеристики.${Symbols.newLine}• Картки Костюмів – відкривають нові костюми для Героїв у грі.`,
  },
  {
  ...
  },
  {
    ...
    answer: `У грі є чотири види карток за рівнем рідкості:${Symbols.newLine}• Звичайні${Symbols.newLine}• Рідкісні${Symbols.newLine}• Епічні${Symbols.newLine}• Легендарні`,
  },
  {
    question: 'Як отримати легендарні картки?',
    answer: `Легендарні картки можна знайти в колекційних наборах:${Symbols.newLine}• «Набір карток Chroma Legends. Неон»${Symbols.newLine}• «Набір карток Chroma Legends. Ксандра» Шукай ці набори на полицях магазинів «Сільпо».`,
  },
  {
  ...
  },
  {
    ...
    answer: `Натисни на іконку з назвою поточного турніру (вона знаходиться над кнопкою “Грати”).${Symbols.newLine}• Хочеш створити власний клан? Натисни “Створити” і стань його капітаном.${Symbols.newLine}• Хочеш приєднатися до клану? Натисни “Переглянути”, щоб переглянути список існуючих кланів і вступити до одного з них.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Кожен раунд турніру в Chroma Legends приносить нові віртуальні нагороди для кланів, які досягають бронзової, срібної, золотої, платинової та діамантової ліг. Актуальну інформацію про нагороди можна знайти в застосунку Chroma Legends. Три клани, що наберуть найбільше турнірних токенів за підсумками кожного турніру, отримають додаткові подарунки від «Сільпо».${Symbols.newLine}1 місце. Бокси з брендованою продукцією гри на вибір організатора можуть містити: рюкзак, килимок, стикерпаки, брелок. Додатково до основної нагороди капітан отримує фігурку персонажа гри на ім’я Мун.${Symbols.newLine}2 та 3 місця. Бокси з брендованою продукцією гри на вибір організатора можуть містити: освітлювальний прилад (нічник), стикерпаки, брелок.
Продукція може бути змінена за рішенням організатора акції. Докладніше – <a href="#${SectionsIds.league}">за посиланням.</a>`,
  },
  {
  ...
  },
  {
    ...
    answer: `Якщо твоє питання стосується Chroma Legends, ти можеш відправити запит через коротку форму за посиланням. Для будь-яких інших запитань обери зручний спосіб зв'язку з нами:${Symbols.newLine}• Напиши в чат <a href="viber://pa?chatURI=Silpochatbot">Viber</a> або <a href="https://t.me/silpo_chatbot" target="_blank" rel="noopener noreferrer">Telegram</a>${Symbols.newLine}• Надішли лист на <a href="mailto:program@silpo.ua">program@silpo.ua</a>${Symbols.newLine}• Зателефонуй на гарячу лінію <a href="tel:0800301707">0 800 301 707</a>`,
  },
  {
  ...
  },
  {
    ...
    answer: `Перенесення прогресу можливе лише між пристроями з однаковою операційною системою (Android → Android або iOS → iOS) і за умови авторизації через той самий обліковий запис.Бик.Якщо ти змінюєш телефон, просто увійди у той самий обліковий запис – прогрес автоматично відновиться.${Symbols.newLine}❗ Зверни увагу: передати дані між Android та iOS неможливо. Якщо ти використовуєш локальний профіль, перенести прогрес не вийде, а у разі видалення гри всі дані буде втрачено.`,
  },
];
