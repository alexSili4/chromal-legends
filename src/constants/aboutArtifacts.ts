...
const healthArtifacts: IArtifact = {
...
const controlArtifacts: IArtifact = {
...
const aboutArtifacts: AboutArtifacts = [
  ...
  {
    name: 'Ікла Ночі',
    artifact: healthArtifacts,
    desc: 'Могутній артефакт, здатний перенаправляти життєву енергію фарб, що пульсує в усіх істотах та предметах Хроміуму',
    crownPosition: {
      leftMob: 49,
      leftDesk: 112,
    },
